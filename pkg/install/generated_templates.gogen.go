...
var templates = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 8, 13, 9, 52, 29, 582318107, time.UTC),
		},
		...
		"/helm-operator-deployment.yaml.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 8, 13, 9, 33, 29, 160217362, time.UTC),
		...
		"/tiller-ca-cert-configmap.yaml.tmpl": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2019, 8, 13, 9, 32, 10, 995665214, time.UTC),
